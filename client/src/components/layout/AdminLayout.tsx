  ...
  return (
    <div className="min-h-screen bg-[#020b1a] text-slate-50">
      <div className="min-h-screen">
        <aside className="fixed inset-y-0 left-0 z-40 hidden w-70 flex-col justify-between overflow-y-auto border-r border-white/10 bg-[#071325]/95 px-5 py-7 shadow-[0_0_0_1px_rgba(148,163,184,0.08)] backdrop-blur-xl lg:flex">
          <div>
            <div className="mb-8 px-2">
              ...
              <div className="mt-4 flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-linear-to-br from-violet-500 to-indigo-500 shadow-lg shadow-violet-500/30">
                ...
                return (
                  <Link
                    ...
                    className={`group flex items-center gap-3 rounded-2xl px-4 py-3.5 text-[15px] font-medium transition-all duration-200 ${
                      isActive
                        ? "bg-linear-to-r from-violet-500 to-indigo-500 text-white shadow-lg shadow-violet-500/20 ring-1 ring-violet-300/40"
        ...
        <div className="min-h-screen min-w-0 lg:pl-70">
          ...
          <main className="mx-auto min-w-0 max-w-360 px-4 py-6 sm:px-6 lg:px-8 lg:py-10">{children}</main>
        </div>
      </div>
    </div>
  );
